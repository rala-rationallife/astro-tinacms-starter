...
pubDate: 2023-02-01T15:00:00.000Z
...
解析が終わったら、取得したい情報を取り出します。BeautifulSoup は、find メソッドや find\_all メソッドを使うことで情報を取り出すことが可能です。例えば、\<h1>のテキストを取得したい場合は、以下のように記述します。
